...
- 🛠️ **As tecnologias utilizadas foram:** HTML5, CSS e a biblioteca de ícones FontsAwesome.
  
- 🎨 O maior desafio foi o uso do **background em grid**. No design de interfaces, esse elemento de fundo poderia distrair o usuário; por isso, o card de login foi feito com bordas espessas e cores sólidas para criar separação visual, além disso, apliquei um overlay de gradiente escurecido (black overlay) sobre a imagem de fundo. Isso reduziu o ruído visual e aumentou o contraste do formulário.
Atualmente, o projeto não possui lógica de autenticação ou integração com banco de dados, funcionando como um **mockup estático** para demonstração de design.
